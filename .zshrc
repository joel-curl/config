...
export PATH="${HOME}/.bin:/opt/chefdk/bin:/usr/local/bin:${HOME}/dev/cassandra/apache-cassandra-3.9/bin:${GOPATH}/bin:${HOME}/.gem/ruby/2.2.0/bin:${HOME}/.bin/node-webkit:/opt/android-studio/bin:/opt/Android/Sdk/platform-tools:/opt/Android/Sdk/tools:/opt/Android/android-ndk-r9d:${PATH}:/home/jcurl/tizen-sdk/tools:/opt/gogland/bin:~/dev/spark-core-tools/bin"
export EDITOR="vim"
